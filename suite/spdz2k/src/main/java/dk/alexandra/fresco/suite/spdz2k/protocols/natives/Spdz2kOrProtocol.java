 ...
 */
public class Spdz2kOrProtocol<PlainT extends CompUInt<?, ?, PlainT>> extends
   ...
   */
  public Spdz2kOrProtocol(DRes<SInt> left, DRes<SInt> right) {
    this.left = left;
    this.right = right;
  }
...
//      final byte[] bytes = new byte[]{(byte) packed};
      ...
      Spdz2kSIntBoolean<PlainT> anded = tripleProduct
      ...
      Spdz2kSIntBoolean<PlainT> xored = factory.toSpdz2kSIntBoolean(left)
          .xor(factory.toSpdz2kSIntBoolean(right));
