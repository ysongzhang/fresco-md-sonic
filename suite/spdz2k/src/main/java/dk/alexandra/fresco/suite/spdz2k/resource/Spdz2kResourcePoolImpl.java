...
public class Spdz2kResourcePoolImpl<PlainT extends CompUInt<?, ?, PlainT>>
  ...
  private final OpenedValueStore<Spdz2kSIntArithmetic<PlainT>, PlainT> storage;
  ...
  public Spdz2kResourcePoolImpl(int myId, int noOfPlayers, Drbg drbg,
      OpenedValueStore<Spdz2kSIntArithmetic<PlainT>, PlainT> storage,
      Spdz2kDataSupplier<PlainT> supplier, CompUIntFactory<PlainT> factory, Function<byte[], Drbg> drbgSupplier, int drbgSeedBitLength) {
  ...
  public Spdz2kResourcePoolImpl(int myId, int noOfPlayers, Drbg drbg,
      OpenedValueStore<Spdz2kSIntArithmetic<PlainT>, PlainT> storage, Spdz2kDataSupplier<PlainT> supplier, CompUIntFactory<PlainT> factory, Function<byte[], Drbg> drbgSupplier) {
  ...
  @Override
  public OpenedValueStore<Spdz2kSIntArithmetic<PlainT>, PlainT> getOpenedValueStore() {
    return storage;
  }
