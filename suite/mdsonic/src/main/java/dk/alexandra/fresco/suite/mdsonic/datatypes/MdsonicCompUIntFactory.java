 ...
 */
public interface MdsonicCompUIntFactory<CompT extends MdsonicCompUInt<?, ?, CompT>> extends OIntFactory {

  @Override
  default BigInteger toBigInteger(OInt value) {
    // TODO test
    return ((MdsonicCompUInt) value).toBigInteger();
  }
  ...
  /**
   * Get result from deferred and downcast result to {@link MdsonicASIntArithmetic <CompT>}.
   */
  default MdsonicASIntArithmetic<CompT> toMdsonicASIntArithmetic(DRes<SInt> value) {
    return Objects.requireNonNull((MdsonicASIntArithmetic<CompT>) value.out());
  }

  /**
   * Get result from deferred and downcast result to {@link MdsonicMSIntArithmetic <CompT>}.
   */
  default MdsonicMSIntArithmetic<CompT> toMdsonicMSIntArithmetic(DRes<SInt> value) {
    return Objects.requireNonNull((MdsonicMSIntArithmetic<CompT>) value.out());
  }
