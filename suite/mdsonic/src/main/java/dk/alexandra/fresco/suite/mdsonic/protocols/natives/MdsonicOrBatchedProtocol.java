...
/**
 * Native protocol for computing logical OR of two values in boolean form.
 */
public class MdsonicOrBatchedProtocol<PlainT extends MdsonicCompUInt<?, ?, PlainT>, SecretP extends MdsonicGF<SecretP>> extends
        MdsonicNativeProtocol<List<DRes<SBool>>, PlainT, SecretP> {

  private final boolean useMaskedEvaluation;

  // Input:
  private final DRes<SBool> extraBit;
  ...
  public MdsonicOrBatchedProtocol(DRes<List<DRes<SBool>>> bitsA,
  ...
  public MdsonicOrBatchedProtocol(DRes<List<DRes<SBool>>> bitsA,
                                  DRes<List<DRes<SBool>>> bitsB,
                                  DRes<SBool> extraBit, boolean useMaskedEvaluation) {
    this.bitsADef = bitsA;
    this.bitsBDef = bitsB;
    this.extraBit = extraBit;
  ...
  public MdsonicOrBatchedProtocol(DRes<List<DRes<SBool>>> bitsA,
                                  DRes<List<DRes<SBool>>> bitsB,
                                  DRes<SBool> extraBit, boolean useMaskedEvaluation, List<SBool> maskedSecrets) {
    this.bitsADef = bitsA;
    this.bitsBDef = bitsB;
    this.extraBit = extraBit;
    this.useMaskedEvaluation = useMaskedEvaluation;
  ...
  public MdsonicOrBatchedProtocol(DRes<List<DRes<SBool>>> bitsA,
    ...
    this(bitsA, bitsB, null, useMaskedEvaluation);
  }

  public MdsonicOrBatchedProtocol(DRes<List<DRes<SBool>>> bitsA,
                                  DRes<List<DRes<SBool>>> bitsB, boolean useMaskedEvaluation, List<SBool> maskedSecrets) {
    this(bitsA, bitsB, null, useMaskedEvaluation, maskedSecrets);
  }
