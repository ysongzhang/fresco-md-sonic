...
/**
 * Native protocol for return product of an edaBit and a daBit.
 */
public class MdsonicGetProductProtocol<PlainT extends MdsonicCompUInt<?, ?, PlainT>, SecretP extends MdsonicGF<SecretP>> extends
  ...
  public EvaluationStatus evaluate(int round, MdsonicResourcePool<PlainT, SecretP> resourcePool,
                                   Network network) {
    this.element = resourcePool.getDataSupplier().getNextInnerProductShare();
