...
/**
 * Native protocol for generating a random shared bit as Arithmetic represent.
 */
public class MdsonicRandomBitAsArithmeticProtocol<PlainT extends MdsonicCompUInt<?, ?, PlainT>, SecretP extends MdsonicGF<SecretP>>
  ...
  public EvaluationStatus evaluate(int round, MdsonicResourcePool<PlainT, SecretP> resourcePool,
                                                  Network network) {
    this.bit = resourcePool.getDataSupplier().getNextBitShareAsArithmetic();
