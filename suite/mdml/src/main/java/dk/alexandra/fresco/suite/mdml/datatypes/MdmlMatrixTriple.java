...
public class MdmlMatrixTriple<PlainT extends MdmlCompUInt<?, ?, PlainT>, SIntT extends MdmlSInt<PlainT>> {

    private final Matrix<SIntT> left;
    private final Matrix<SIntT> right;
    private final Matrix<SIntT> product;

    public MdmlMatrixTriple(Matrix<SIntT> left, Matrix<SIntT> right, Matrix<SIntT> product) {
