...
import dk.alexandra.fresco.suite.mdml.protocols.natives.InsecureBroadcastProtocol;
 ...
 */
public class CommitmentComputationMdml implements
  ...
  public CommitmentComputationMdml(ByteSerializer<HashBasedCommitment> commitmentSerializer,
  ...
  public DRes<List<byte[]>> buildComputation(ProtocolBuilderNumeric builder) {
    ...
    return builder.seq(new BroadcastComputation<>(
        commitmentSerializer.serialize(ownCommitment), noOfParties > 2))
