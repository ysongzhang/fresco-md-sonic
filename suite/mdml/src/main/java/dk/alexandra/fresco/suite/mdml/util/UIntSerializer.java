package dk.alexandra.fresco.suite.mdml.util;
...
/**
 * Serializer for {@link MdmlCompUInt} instances.
 */
public class UIntSerializer<PlainT extends MdmlCompUInt<?, ?, PlainT>> implements
   ...
   */
  public UIntSerializer(MdmlCompUIntFactory<PlainT> factory) {
