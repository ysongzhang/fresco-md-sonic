 ...
 */
public class MdmlCompUIntArithmetic<CompT extends MdmlCompUInt<?, ?, CompT>> implements OIntArithmetic {

  private final MdmlCompUIntFactory<CompT> factory;
  private final List<OInt> powersOfTwo;

  public MdmlCompUIntArithmetic(MdmlCompUIntFactory<CompT> factory) {
  ...
  public OInt shiftRight(OInt input, int n) {
    return factory.fromOInt(input).shiftRightLowOnlySigned(n);
