...
public class RegularBitVector implements BitVector {
  ...
  public boolean[] getBits() {
    throw new UnsupportedOperationException("Regular BitVector does not support getBits");
  }
  ...
  public void setBits(boolean[] value) {
    throw new UnsupportedOperationException("Regular BitVector does not support setBits");
  }
