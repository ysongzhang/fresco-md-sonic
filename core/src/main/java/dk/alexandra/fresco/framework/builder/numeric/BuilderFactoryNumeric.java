...
public interface BuilderFactoryNumeric extends BuilderFactory<ProtocolBuilderNumeric> {
  ...
  default Numeric createNumeric(ProtocolBuilderNumeric builder) {
    throw new UnsupportedOperationException("Don't support numeric mode.");
  }

  default NumericMdsonic createNumericMdsonic(ProtocolBuilderNumeric builder) {
    throw new UnsupportedOperationException("Don't support numeric Mdsonic mode.");
  }

  default NumericMdsonic createNumericMdsonic(ProtocolBuilderNumeric builder, boolean useMaskedEvaluation) {
    throw new UnsupportedOperationException("Don't support numeric Mdsonic mode.");
  }

  default Conversion createConversion(ProtocolBuilderNumeric builder) {
    throw new UnsupportedOperationException("Don't support conversion mode.");
  }

  default ConversionMdsonic createConversionMdsonic(ProtocolBuilderNumeric builder) {
    throw new UnsupportedOperationException("Don't support conversion Mdsonic mode.");
  }
  ...
  default ComparisonMdsonic createComparisonMdsonic(ProtocolBuilderNumeric builder) {
    throw new UnsupportedOperationException("Don't support comparison Mdsonic mode.");
  }
  ...
  default AdvancedNumericMdsonic createAdvancedNumericMdsonic(ProtocolBuilderNumeric builder) {
    throw new UnsupportedOperationException("Don't support advanced numeric Mdsonic mode.");
  }
  ...
  default RealNumericMdsonic createRealNumericMdsonic(ProtocolBuilderNumeric builder) {
    throw new UnsupportedOperationException("Don't support real numeric Mdsonic mode.");
  }
  ...
  default AdvancedRealNumericMdsonic createAdvancedRealNumericMdsonic(ProtocolBuilderNumeric builder) {
    throw new UnsupportedOperationException("Don't support advanced real numeric Mdsonic mode.");
  }
  ...
  default LogicalBoolean createLogicalBoolean(ProtocolBuilderNumeric builder) {
    throw new UnsupportedOperationException("Don't support logical boolean mode.");
  }

  default LogicalBoolean createLogicalBoolean(ProtocolBuilderNumeric builder, boolean useMaskedEvaluation) {
    throw new UnsupportedOperationException("Don't support logical boolean mode.");
  }
