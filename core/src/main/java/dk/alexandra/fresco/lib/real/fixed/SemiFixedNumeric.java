...
public class SemiFixedNumeric implements RealNumeric {
  ...
  public DRes<SInt> lt(DRes<SReal> a, DRes<SReal> b) {
    throw new IllegalArgumentException("Don't support Compare Less Than now!");
  }

  public DRes<SInt> equals(DRes<SReal> a, DRes<SReal> b) {
    throw new IllegalArgumentException("Don't support Compare equals now!");
  }

  public DRes<SInt> zero(DRes<SReal> a, int bitLength) {
    throw new IllegalArgumentException("Don't support Compare equal to zero now!");
  }
}
