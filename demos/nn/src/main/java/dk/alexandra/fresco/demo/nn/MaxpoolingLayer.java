...
import dk.alexandra.fresco.demo.utils.ParallelMaxPooling;
...
public class MaxpoolingLayer implements Layer {  // Output Column Vector

    private final boolean useMdsonic;
    private DRes<Matrix<DRes<SReal>>> v;  // Column Vector
    private MaxpoolingLayerParameters parameters;

    public MaxpoolingLayer(MaxpoolingLayerParameters parameters,
    ...
    public DRes<Matrix<DRes<SReal>>> buildComputation(ProtocolBuilderNumeric builder) {
        ...
        return builder.seq(r -> {
            ...
            return () -> input_transpose;
                ...
                (r2, list) -> r2.seq(new ParallelMaxPooling(list, useMdsonic)))
