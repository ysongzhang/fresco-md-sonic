...
import dk.alexandra.fresco.demo.utils.AveragePooling;
...
public class AvgpoolingLayer implements Layer {  // Output Column Vector

    private DRes<Matrix<DRes<SReal>>> v;  // Column Vector
    private AvgpoolingLayerParameters parameters;

    public AvgpoolingLayer(AvgpoolingLayerParameters parameters,
    ...
    public DRes<Matrix<DRes<SReal>>> buildComputation(ProtocolBuilderNumeric builder) {
        ...
        return builder.seq(r -> {
                ...
                }).seq((r2, inputs) -> r2.seq(new AveragePooling(inputs)))
